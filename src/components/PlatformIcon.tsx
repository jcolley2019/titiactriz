 ...
 *
 * Three catalog platforms have NO mark in the icon set — Lemon8, Whop and
 * Bigo Live — and fall through to the generic link glyph in brand gold. That is
 * the source app's own behaviour for the first two, not a gap opened here.
 * Bigo Live joins them until an official SVG is supplied: the face law's
 * sibling applies to brands too, and a mark traced from a screenshot is not
 * "as the brand draws it".
 */
