...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-primary/90 hover:-translate-y-0.5 hover:shadow-lg shadow-soft rounded-sm",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90 hover:-translate-y-0.5 hover:shadow-lg rounded-sm",
        outline:
          "border border-input bg-background hover:bg-accent hover:text-accent-foreground hover:-translate-y-0.5 hover:shadow-md rounded-sm",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80 hover:-translate-y-0.5 hover:shadow-md rounded-sm",
        ...
        "gold-outline":
          "border border-accent/50 bg-transparent text-accent hover:bg-accent/10 hover:border-accent hover:-translate-y-0.5 hover:shadow-md hover:shadow-accent/20 tracking-[0.15em] uppercase text-xs font-sans font-medium rounded-none",
        cosmic:
          "relative bg-transparent border border-foreground/20 text-foreground hover:border-accent hover:text-accent hover:-translate-y-0.5 tracking-[0.2em] uppercase text-xs font-sans font-medium rounded-none overflow-hidden before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-accent/10 before:to-transparent before:-translate-x-full hover:before:translate-x-full before:transition-transform before:duration-700",
        blush:
          "bg-secondary text-foreground hover:bg-secondary/80 hover:-translate-y-0.5 hover:shadow-md shadow-soft rounded-sm",
        subtle:
          "bg-muted text-muted-foreground hover:bg-muted/80 hover:text-foreground hover:-translate-y-0.5 rounded-sm",
      },
      size: {
