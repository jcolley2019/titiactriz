  ...
  return (
    <div style={editorialFontVars}>
      ...
      <section
        ref={heroRef}
        className={
          "relative min-h-[calc(100svh-100px)] md:min-h-[calc(100vh-38px)] flex items-stretch md:items-center justify-center overflow-hidden px-4 md:px-12 pt-[72px] md:pt-20 pb-2 md:pb-12 " +
