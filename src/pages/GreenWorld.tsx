...
import categoryNatural from "@/assets/greenworld-natural-health.webp";
import categoryEnergy from "@/assets/greenworld-category-energy.webp";
import categoryBeauty from "@/assets/greenworld-category-beauty.webp";
import premiumImage from "@/assets/greenworld-premium.webp";
  ...
  return (
    <>
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-gradient-to-br from-gw-green via-gw-green to-gw-green-dark">
        ...
        <div className="container-editorial relative z-10 pt-[400px] md:pt-[500px] pb-16 sm:pb-20 px-6 md:px-12 lg:px-16">
